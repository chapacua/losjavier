...
<section id="team" class="pb-5">
  <div class="container">
    <h5 class="section-title h1">Mejor Estudiante</h5>
    <p class="text-center">¿Para ti quien es la persona que en su conjunto de actitudes tanto academicas como disciplinarias, puede considerarse el mejor estudiante?</p>
    <div class="row">
      <!-- Team member -->
              ...
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <?php echo form_open('Votacion/guardar/'); ?>
                    <input type="hidden" name="categoria" value="mejorEstudiante">
