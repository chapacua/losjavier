...
<section id="team" class="pb-5">
  <div class="container">
    <h5 class="section-title h1">Inpuntualidad</h5>
    <p class="text-center">¿Quíen es esa persona que siempre llega tarde, o nunca asiste a clase, que parece un fantasma y que ni la voz le conoces?</p>
    <div class="row">
      <!-- Team member -->
              ...
              <div class="card">
                <div class="card-body text-center">
                  ...
                  <?php echo form_open('Votacion/guardar/'); ?>
                    <input type="hidden" name="categoria" value="puntualidadInv">
